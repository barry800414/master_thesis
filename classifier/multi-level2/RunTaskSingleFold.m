function [ ] = RunTaskSingleFold( dataFile, method, update, stop, learn_rate, maxIter, seed, fid, debugLevel, outFilePrefix )
% to do: 
...
[ model, F_train ] = train( method, XTrain, yTrain, c1, c2, ...
    newParams, 2 );
F_test = preCompute( method, XTest.F_sta, XTest.F_subj );
